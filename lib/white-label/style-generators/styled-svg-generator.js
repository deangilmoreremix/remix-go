...
.theme-${id} .new-text-icon .cls-3,
.theme-${id} .new-lead-generator-disabled-icon .cls-1,
.theme-${id} .new-image-icon .cls-2,
.theme-${id} .new-personalized-icon .cls-2,
.theme-${id} .new-lead-generator-disabled-icon .cls-2,
.theme-${id} .new-text-icon:hover .cls-1,
.theme-${id} .new-personalized-icon:hover .cls-2,
.theme-${id} .new-text-icon:hover .cls-3,
.theme-${id} .new-lead-generator-enabled-icon .cls-1,
.theme-${id} .new-lead-generator-enabled-icon .cls-2,
.theme-${id} .edit-svg .cls-1,
.theme-${id} .edit-svg .cls-2,
...
.theme-${id} .video-upload-icon .cls-1,
.theme-${id} .my-project-icon .cls-2,
.theme-${id} .new-text-icon .cls-4,
.theme-${id} .new-image-icon .cls-3,
.theme-${id} .new-personalized-icon .cls-3,
.theme-${id} .new-lead-generator-disabled-icon .cls-3,
.theme-${id} .new-text-icon:hover .cls-1,
.theme-${id} .new-image-icon:hover .cls-1,
.theme-${id} .new-personalized-icon:hover .cls-1,
.theme-${id} .new-text-icon .cls-2,
.theme-${id} .new-image-icon .cls-5,
.theme-${id} .new-personalized-icon .cls-5,
.theme-${id} .new-lead-generator-disabled-icon .cls-4,
.theme-${id} .new-image-icon .cls-4,
.theme-${id} .new-personalized-icon .cls-4,
.theme-${id} .pause-cta-disabled-icon .cls-2,
.theme-${id} .loop-disabled-icon .cls-2,
.theme-${id} .facebook-disabled-icon .cls-2,
.theme-${id} .linkedin-disabled-icon .cls-2,
.theme-${id} .new-personalized-icon:hover .cls-3,
.theme-${id} .new-image-icon:hover .cls-3,
.theme-${id} .new-lead-generator-enabled-icon .cls-1,
.theme-${id} .new-lead-generator-enabled-icon .cls-3,
.theme-${id} .edit-svg .cls-2,
.theme-${id} .from-template-icon .cls-2 {
