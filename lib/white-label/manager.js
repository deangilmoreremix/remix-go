...
class WhiteLabelManager {
  ...
  get css() {
    ...
    return generateWhiteLabelCSS(_id, brandLogo, {
      primaryColor: theme.accent2Color,
      stageSelectColor: Chroma(theme.accent2Color).darken(0.33).css(),
      phaseHighlightColor: Chroma(theme.accent2Color).desaturate(1.5).brighten(0.8).css(),
    });
  }
}
