  ...
  render() {
    ...
    return (
      <div className="popcorn-editor text-editor">
          ...
          { this.state.showFontColorPicker ?
            <div className="color-picker">
              ...
              <ChromePicker
                ...
                onChangeComplete={color => this.updateElement('fontColor', color.hex)}
              />
            </div> : null }
        </div>
        <div>
            ...
            <div className="color-picker">
              ...
              <ChromePicker
                ...
                onChangeComplete={color =>
                  this.updateMultiple({ background: true, backgroundColor: color.hex })}
              />
            </div> : null }
        </div>
        <div
          className={`decoration-toggle bold ${(element.fontDecorations && element.fontDecorations.bold) ? 'active' : ''}`}
          onClick={() =>
        ...
        <div
          className={`decoration-toggle italic ${(element.fontDecorations && element.fontDecorations.italic) ? 'active' : ''}`}
          onClick={() =>
            this.updateElement('fontDecorations', {
