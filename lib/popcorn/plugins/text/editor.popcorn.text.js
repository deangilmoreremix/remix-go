      ...
      <div className="popcorn-editor text-editor">
        ...
        <div
          onClick={() => {
            ...
            this.setState({bold: !element.fontDecorations.bold});
          }}
          className={`decoration-toggle bold ${element.fontDecorations.bold ? 'active' : ''} ${this.bold ? 'active' : ''}`}
          data-tip="Bold"
        >
          B
        </div>
        <div
          onClick={() => {
            ...
            this.setState({italics: !element.fontDecorations.italics});
          }}
          className={`decoration-toggle italic ${(element.fontDecorations && element.fontDecorations.italics) ? 'active' : ''} ${this.italics ? 'active' : ''}`}
          data-tip="Italic"
        >
          I
        </div>
