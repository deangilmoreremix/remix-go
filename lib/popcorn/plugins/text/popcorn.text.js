...
((Popcorn, jQuery) => {
  ...
  Popcorn.plugin('text', {
    ...
    _setup(options) {
      ...
      const transition = options.transition || options._natives.manifest.options.transition.default;
      ...
      options._contentContainer.addEventListener('dblclick', () => {
      ...
      options._container.addEventListener('mouseenter', () => {
        if (!options._container.querySelector('*[contenteditable=""]') &&
    ...
    _update(trackEvent, options) {
      ...
      if (options.fontFamily && options.fontFamily !== trackEvent.fontFamily) {
      ...
      if (options.padding && options.padding !== trackEvent.padding) {
      ...
      if (options.fontSize && options.fontSize !== trackEvent.fontSize) {
        trackEvent.fontSize = options.fontSize;
      }

      if (options.zindex && options.zindex !== trackEvent.zindex) {
      ...
      if (options.rotation && options.rotation !== trackEvent.rotation) {
        trackEvent.rotation = options.rotation;
      }

      if (options.fontColor && options.fontColor !== trackEvent.fontColor) {
        trackEvent.fontColor = options.fontColor;
      }

      if (options.shadow && options.shadow !== trackEvent.shadow) {
        trackEvent.shadow = options.shadow;
      }

      if (options.shadowColor && options.shadowColor !== trackEvent.shadowColor) {
      ...
      if (options.backgroundColor && options.backgroundColor !== trackEvent.backgroundColor) {
        trackEvent.backgroundColor = options.backgroundColor;
      }

      if (options.stroke && options.stroke !== trackEvent.stroke) {
      ...
      if (options.text && options.text !== trackEvent.text) {
        trackEvent.text = options.text;
      }

      if (options.linkUrl && options.linkUrl !== trackEvent.linkUrl) {
        trackEvent.linkUrl = options.linkUrl;
      }

      if (options.linkTarget && options.linkTarget !== trackEvent.linkTarget) {
