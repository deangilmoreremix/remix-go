...
((Popcorn, jQuery) => {
  ...
  Popcorn.plugin('text', {
    ...
    _update(trackEvent, options) {
      ...
      if (options.fontDecorations !== undefined && options.fontDecorations !== trackEvent.fontDecorations) {
      ...
      if (options.backgroundColor !== undefined && options.backgroundColor !== trackEvent.backgroundColor) {
