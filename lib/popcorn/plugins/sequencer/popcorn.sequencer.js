  ...
  Popcorn.plugin( "sequencer", {
    _setup: function( options ) {
      ...
      options.addSource = function() {
        ...
        options._clip = Popcorn.smart( options._container, options.source, { frameAnimation: true, framerate: 120 } );
      ...
      options._onSeekBack = function(event) {
        if (options.active && event && event.detail.data) {
          for (var i = 0; i < Popcorn.instances.length; i++) {
