...
(function( Butter, VariableDescriptorFactory ) {
  ...
  Editor.register( "personalizedImage", "load!{{baseDir}}plugins/personalizedImage-editor.html",
    ...
    function setup( trackEvent ) {
      ...
      function attachHandlers() {
        ...
        _urlInput.parentElement.appendChild(VariableDescriptorFactory.createPersonalizedImageButton({ target: _urlInput }));
