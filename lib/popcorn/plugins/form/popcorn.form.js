  ...
  Popcorn.plugin('form', () => {
    ...
    function buildForm(options) {
      ...
      const addInputElement = (declaration, index) => {
        ...
        inputWrapper.appendChild(containerEditBtn);
        return inputWrapper;
      };
      ...
      formElementContainer.style.width = '79%';
      ...
      const containerConfirmBtn = document.createElement('div');
      containerConfirmBtn.classList.add('container-confirm-button');
      divButton.classList.add('div-button');

      divButton.classList.add('confirm-button');
      const buttonText = document.createElement('span');
      buttonText.innerText = options.btnText || 'Confirm';
      ...
      containerConfirmBtn.appendChild(divButton);
      containerConfirmBtn.appendChild(submitEditButton);

      wrapperContainer.appendChild(containerConfirmBtn);
      ...
      if (options.elements.length === 2) {
        ...
        formElementContainer.style.display = 'flex';
        formElementContainer.style.width = '90%';
        wrapperContainer.style.flexDirection = 'column';
        for (let i = 0; i < formElementContainer.childNodes.length - 1; i += 1) {
          formElementContainer.childNodes[i].style.width = '49%';
        }
        formElementContainer.childNodes[2].style.width = '78%';
        formElementContainer.appendChild(containerConfirmBtn);
