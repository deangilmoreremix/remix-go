...
(function (Popcorn) {
  ...
  Popcorn.plugin('form', () => {
    ...
    function buildForm(options) {
      const addInputElement = (declaration) => {
        ...
        removeButton.addEventListener('click', () => {
          options.elements = options.elements.splice(options.elements.indexOf(declaration), 1);
      ...
      options.elements.forEach(
        declaration => formElementContainer.appendChild(addInputElement(declaration)),
      );
      ...
      addFieldButton.addEventListener('click', () => {
        ...
        formElementContainer.appendChild(addInputElement({
          type: 'singleline',
          label: 'Untitled',
          token: 'UNTITLED',
        }));
