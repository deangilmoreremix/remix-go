  ...
  Popcorn.plugin('form', () => {
    ...
    function buildForm(options) {
      ...
      const addInputElement = (declaration, index) => {
        ...
        dragButton.classList.add('action-button', 'input-drag');
        dragButton.appendChild(document.createElement('img'));

        const dropDownContainer = document.createElement('div');
        dropDownContainer.classList.add('dropdown');
        dropDownContainer.appendChild(dragButton);
        ...
        input.addEventListener('blur', ({ target }) => {
          if (input.hasAttribute('contenteditable')) {
            ...
            options.elements[declaration.id].token = encodeURIComponent(value.toUpperCase().split(' ').join('_'));
      ...
      const innerWidth = options.innerWidth || options._natives.manifest.options.innerWidth.default;
      if (!isMobile()) {
      ...
      captionEditButton.classList.add('action-button', 'edit-button');
      ...
      disclaimerEditButton.classList.add('action-button', 'edit-button');
      ...
      privacyEditButton.classList.add('action-button');
      privacyEditButton.classList.add('edit-button');
    ...
    return {
      _setup(options) {
        ...
        const existsOptions = ['privacyDisclaimer', 'fontFamily', 'fontSize', 'innerOpacity',
          ...
          'innerHeight', 'innerColor', 'btnWidth', 'btnAlignment', 'buttonBorderRadius', 'start',
          'end', 'target', 'zindex', 'width', 'height', 'captionFontSize', 'captionAlignment',
          'innerWidth', 'innerHeight', 'innerColor', 'innerOpacity', 'backgroundImage', 'btnWidth',
          'btnBottomBorder', 'elements'];
