...
export default class FormEditor extends PopcornEditor {
  ...
  testWebhook = async () => {
    ...
    try {
      ...
      console.error(`isload ${this.isLoading}`);
    }
  };
    ...
    return (
      <React.Fragment>
            ...
            : (
              <button
                ...
                disabled={
                      ...
                      || this.validationState.error.type === errorTypes.webhook}
              >
                    Test Webhook
              </button>
            )
        ...
        <button
          ...
          disabled={this.validationState.error.value}
        >
          Save
        </button>
      </React.Fragment>
    ...
    return (
      <div className="popcorn-editor text-editor">
        ...
        <Input
          ...
          onChange={this.onChange('fontFamily')}
        ...
        <SVGInline
          ...
          onClick={this.openPopup(<ImageUpload onFileUploaded={(url) => {
            this.updateElement('backgroundImage', url);
            PopupboxManager.close();
          }}
        ...
        <SVGInline
          ...
          svg={SVGLogoUpload}
          cleanup={['title']}
          alt="Upload Logo Image"
          onClick={this.openPopup(<ImageUpload onFileUploaded={(url) => {
            this.updateElement('brandLogoSrc', url);
            PopupboxManager.close();
          }}
          />, 'Upload a new logo image')}
          data-tip="Upload/Replace logo image"
        />
        <div className="separator" />
        <div className="icon-group color-picker-button-container">
          <button
