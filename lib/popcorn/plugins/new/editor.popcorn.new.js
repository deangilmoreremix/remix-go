...
export default class NewElementBar extends PopcornEditor {
  ...
  render() {
    const { project, defaultImage, features } = this.props;
    return (
      <div className="popcorn-editor new-bar">
        ...
        >
          <SVGInline className="icon new-text-icon" classSuffix="" svg={SVGNewText} />
        </button>
        <button
          className="action-button"
          onClick={() => this.addElement('image', {
            src: defaultImage || 'https://go.videoremix.io/static/images/logo.svg',
            linkSrc: 'http://example.com',
            width: 33,
            height: 33,
            top: 35,
            left: 35,
        ...
        >
          <SVGInline className="icon new-image-icon" classSuffix="" svg={SVGNewImage} />
        </button>
        <button
          className="action-button"
        ...
        >
          <SVGInline className="icon new-personalized-icon" classSuffix="" svg={SVGNewPersonalizedImage} />
        </button>
