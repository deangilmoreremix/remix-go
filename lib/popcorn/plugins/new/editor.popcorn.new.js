...
import SVGNewTextDisabled from '../../../../static/images/editor/elements/new/new_text-disabled.svg';
import SVGNewTextEnabled from '../../../../static/images/editor/elements/new/new_text-enabled.svg';

import SVGNewImageDisabled from '../../../../static/images/editor/elements/new/new_image-disabled.svg';
import SVGNewImageEnabled from '../../../../static/images/editor/elements/new/new_image-enabled.svg';

import SVGNewLeadGeneratorDisabled from '../../../../static/images/editor/elements/new/new_lead_generator-disabled.svg';
import SVGNewLeadGeneratorEnabled from '../../../../static/images/editor/elements/new/new_lead_generator-enabled.svg';

import SVGNewPersonalizedImageDisabled from '../../../../static/images/editor/elements/new/new_personalized-disabled.svg';
import SVGNewPersonalizedImageEnabled from '../../../../static/images/editor/elements/new/new_personalized-enabled.svg';
...
export default class NewElementBar extends PopcornEditor {
  static propTypes = {
   ...
   toggleElementHover(name) {
     const { elementsHover } = this.state;
     if (elementsHover.indexOf(name) === -1) {
       elementsHover.push(name);
       this.setState({ elementsHover });
     } else {
       elementsHover.splice(this.state.elementsHover.indexOf(name), 1);
       this.setState({ elementsHover });
     }
   }
     ...
     return (
       <div className="popcorn-editor new-bar">
         ...
         <button
           ...
           onMouseEnter={() => this.toggleElementHover('new-text')}
           onMouseLeave={() => this.toggleElementHover('new-text')}
           data-tip="Add new text element"
         >
           <SVGInline
             className={`icon new-text-${elementsHover.indexOf('new-text') !== -1 ? 'enabled' : 'disabled'}-icon`}
             classSuffix=""
             svg={elementsHover.indexOf('new-text') !== -1 ? SVGNewTextEnabled : SVGNewTextDisabled}
             cleanup={['title']}
           />
         </button>
         <button
           ...
           onMouseEnter={() => this.toggleElementHover('new-image')}
           onMouseLeave={() => this.toggleElementHover('new-image')}
           data-tip="Add new image element"
         >
           <SVGInline
             className={`icon new-image-${elementsHover.indexOf('new-image') !== -1 ? 'enabled' : 'disabled'}-icon`}
             classSuffix=""
             svg={elementsHover.indexOf('new-image') !== -1 ? SVGNewImageEnabled : SVGNewImageDisabled}
             cleanup={['title']}
           />
         </button>
         <button
           ...
           onMouseEnter={() => this.toggleElementHover('new-personalized')}
           onMouseLeave={() => this.toggleElementHover('new-personalized')}
           data-tip="Add new personalized image element"
         >
           <SVGInline
             className={`icon new-personalized-${elementsHover.indexOf('new-personalized') !== -1 ? 'enabled' : 'disabled'}-icon`}
             classSuffix=""
             svg={elementsHover.indexOf('new-personalized') !== -1 ? SVGNewPersonalizedImageEnabled : SVGNewPersonalizedImageDisabled}
             cleanup={['title']}
           />
         </button>
         { (store.isAdmin() ||
          ...
          >
            <SVGInline
              className={`icon new-lead-generator-${project.elements.some(item => item.type === 'form') ? 'enabled' : 'disabled'}-icon`}
              classSuffix=""
              svg={project.elements.some(item => item.type === 'form') ? SVGNewLeadGeneratorEnabled : SVGNewLeadGeneratorDisabled}
              cleanup={['title']}
            />
          </button>
          )
