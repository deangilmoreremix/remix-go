...
define(['json!/api/butterconfig', 'jquery'], (config, $) => {
  const SUPPORTED_KEYS = ['EMAIL', 'NAME', 'FIRSTNAME', 'LASTNAME', 'IMAGE', 'GENDER'];
  ...
  const SOCIALIZER_APP_ID = '701751126630371';
  const DEFAULT_APP_ID = SOCIALIZER_APP_ID;
