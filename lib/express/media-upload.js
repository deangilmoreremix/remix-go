  ...
  function uploadFromFile() {
    ...
    return Promise
      .all([
        ...
        new Promise((resolve) => {
          return resolve(null);
          // todo i commented it. I think it's need move on backend
          // if (isVideoSource) {
          ...
          //     //
          //     return childProcess
          //       .execAsync(`ffmpeg -i ${media.path} -c:v libvpx --rt ${media.path}.webm`)
      ...
      .then(([media, preview]) => {
        ...
        return res.json(Object.assign(media, { preview }));
      })
