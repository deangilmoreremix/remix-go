          ...
          <artdeco id="ARTDECO-DROPDOWN_3">
            ...
            <artdeco id="ARTDECO-DROPDOWN-CONTENT_8">
              <ul id="UL_9">
                ...
                <div id="DIV_15">
                  <span id="SPAN_16">Copy link to post</span><span id="SPAN_17"></span>
                </div>
              </ul>
            </artdeco>
            <artdeco id="ARTDECO-DROPDOWN-ITEM_19">
              ...
              <div id="DIV_23">
                <span id="SPAN_24">Embed this post</span> <span
                id="SPAN_25">Copy and paste embed code on your site</span>
              </div>
            </artdeco>
            <artdeco id="ARTDECO-DROPDOWN-ITEM_27">
              ...
              <div id="DIV_31">
                <span id="SPAN_32">Edit post</span><span id="SPAN_33"></span>
              </div>
            </artdeco>
            <artdeco id="ARTDECO-DROPDOWN-ITEM_35">
              ...
              <div id="DIV_39">
                <span id="SPAN_40">Delete post</span><span id="SPAN_41"></span>
              </div>
            </artdeco>
            <artdeco id="ARTDECO-DROPDOWN-ITEM_43">
              ...
              <div id="DIV_47">
                <span id="SPAN_48">Disable comments on this post</span><span id="SPAN_49"></span>
              </div>
            </artdeco>
          </artdeco>
        </div>
